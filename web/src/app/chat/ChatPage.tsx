...
export function ChatPage({
  ...
  const toggleSideBarSessions = (target: DocumentSidebarSessionsProps) =>{
    setSidebarSessions(target)
  }
  ...
  return (
    <>
      ...
      <div className={`${isResponsive ? 'fixed' : 'flex-grow'} inset-0 flex flex-col text-default`}>
